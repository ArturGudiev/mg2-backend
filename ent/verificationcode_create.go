...
func (_c *VerificationCodeCreate) SetUserID(v int) *VerificationCodeCreate {
...
func (_c *VerificationCodeCreate) SetID(v int) *VerificationCodeCreate {
	_c.mutation.SetID(v)
	return _c
}
...
func (_c *VerificationCodeCreate) check() error {
	if _, ok := _c.mutation.UserID(); !ok {
		return &ValidationError{Name: "user_id", err: errors.New(`ent: missing required field "VerificationCode.user_id"`)}
	}
	...
	if v, ok := _c.mutation.ID(); ok {
		if err := verificationcode.IDValidator(v); err != nil {
			return &ValidationError{Name: "id", err: fmt.Errorf(`ent: validator failed for field "VerificationCode.id": %w`, err)}
		}
	}
