...
const (
	// Label holds the string label denoting the carduser type in the database.
	Label = "card_user"
	...
	EdgeUser = "user"
	// Table holds the table name of the carduser in the database.
	Table = "card_users"
	// CardTable is the table that holds the card relation/edge.
	CardTable = "card_users"
...
// Columns holds all SQL columns for carduser fields.
var Columns = []string{
	FieldID,
	FieldCardID,
	FieldUserID,
...
// OrderOption defines the ordering options for the CardUser queries.
